 ...
 * @author rupak
 */
public class viewlibdetails extends HttpServlet {
...
RequestDispatcher rd=req.getRequestDispatcher("test3.html");
        ...
        if(rs.next())
        {
             out.println("<html><body><br><br><br><br>");
            out.println("<table border=1 width=100% height=30%>");
            out.println("<tr><th><b>NAME</th><th><b>LIBRARIAN ID</th><th><b>GMAIL</th></tr>");
            out.println("<tr><td><center>"+rs.getString(1)+"</center>"+"</td><td><center>"+rs.getString(2)+"</center>"+"</td><td><center>"+rs.getString(3)+"</center>"+"</td></tr>");
            out.println("</table>");
