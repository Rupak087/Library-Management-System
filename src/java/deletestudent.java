...
RequestDispatcher rd=req.getRequestDispatcher("test2.html");
        ...
        if(rs.next())
        {
          ...
          PreparedStatement ps1=con.prepareStatement("delete from t11 where SID=?");
           ps1.setString(1,sid);
...
"<center><font face=Matura MT Script Capitals size=7><u><i>Thanku you deleted "+name+"  succesfully  \n" +
"</center></body></html>");   
